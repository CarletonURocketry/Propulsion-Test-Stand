...
class MCP9600:
    ...
    **Quickstart: Importing and using the MCP9600 temperature sensor**
    ...
    def __init__(self, i2c: Any, address: int = _DEFAULT_ADDRESS, tctype: str = "K", tcfilter: int = 0,
    ) -> None:
    ...
    def alert_config(self, *, alert_number: int, alert_temp_source: int, alert_temp_limit: float, alert_hysteresis: float, alert_temp_direction: int,  alert_mode: int, alert_state: int) -> None:
