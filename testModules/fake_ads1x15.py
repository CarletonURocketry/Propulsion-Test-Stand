...
class ADS1x15:
    ...
    def __init__(self, i2c: Any, gain: float = 1, data_rate: Optional[int] = None, mode: int = Mode.SINGLE, address: int = _ADS1X15_DEFAULT_ADDRESS,
    ):
    ...
    def read(self, pin: Any, is_differential: bool = False) -> int:
